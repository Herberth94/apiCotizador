...
import { CRUDColaboradoresVenta } from "../Routes/CRUDColaboradoresVenta";
...
function AdministrarColaboradoresVenta(props) {
  /*========================== Mostrar/Ocultar ==========================*/
  ...
  const getColabs = async (pId) => {
    try {
      const resColabs = await axios.get(
        url2 + `/api/cotizador/viewUsersVentaP/${pId}`
      );
...
export default AdministrarColaboradoresVenta;
