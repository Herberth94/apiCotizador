  ...
  async function Send(dPrecio) {
    ...
    if (pEstatus1 === "En revision") {
      ...
      try {
        ...
        const resGetProyectos = await axios.get(
        ...
        if (pId !== proyectoId.proyecto_id && pId !== "") {
          ...
          await axios.put(
            url2 + `/api/cotizador/proyecto/updateFM/${proyectoId.proyecto_id}`,
            dataFM
          );
        }
        ...
        if (pId !== proyectoId.proyect && pId !== "") {
          ...
          const respuesta = await axios.post(
            url2 + `/api/cotizador/catd/agregar/${pId}`,
            data
          );
          //console.log(pId);
          ...
          const respuesta2 = await axios.post(
            url2 + `/api/cotizador/catd/agregar/${proyectoId.proyecto_id}`,
            data
          );
          //console.log(pId);
        ...
        console.log(error);
        alert(
          "Error al agregar los datos de una categoría, asegurate de seleccionar el tipo de categoría y moneda"
        );
      }
    }
  }
  ...
  async function finalizarProy(clave) {
    ...
    try {
      ...
      if (pId !== undefined && pId !== "") {
        ...
        await axios.put(
          url2 + `/api/cotizador/proyecto/updateEstatus/${pId}`,
          dataEstatus
        );
        swal({
        ...
        await axios.put(
          url2 + `/api/cotizador/proyecto/updateFM/${clave}`,
          dataFM
        );
        await axios.put(
          url2 + `/api/cotizador/proyecto/updateEstatus/${clave}`,
          dataEstatus
        );
        swal({
          title: "Finalizar proyecto",
      ...
      if (pEstatus1 === "En revision") {
        ...
        if (pId !== undefined && pId !== "") {
          ...
          await axios.post(
            url2 + `/api/cotizador/proporcionalidad/insert/${pId}`
          );
          /*======================================================================*/
        } else {
          //Inserción de estatus al proyecto
          ...
          /*=============== Inserción de datos de proporcionalidad ===============*/
          await axios.post(
            url2 + `/api/cotizador/proporcionalidad/insert/${clave}`
          );
          /*======================================================================*/
          // alert('Se finalizó el proyecto correctamente');
          // alert('El proyecto entro al estatus: En revisón');
