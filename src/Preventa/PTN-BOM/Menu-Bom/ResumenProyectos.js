  ...
  const getProyectos = async () => {
    try {
      if (validatorrol === "direccion") {
        ...
        if (
          URLactual === "http://localhost:3000/mis-proyectos-r" ||
          URLactual === "http://10.200.10.9:3000/mis-proyectos-r"
        ) {
          const resProy = await axios.get(
          ...
          URLactual === "http://localhost:3000/proyectos-compartidos-r" ||
          URLactual === "http://10.200.10.9:3000/proyectos-compartidos-r"
        ) {
          const resProy = await axios.get(
