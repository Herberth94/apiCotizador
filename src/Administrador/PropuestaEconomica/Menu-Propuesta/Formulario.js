  ...
  return (
    <div className="">
      <div className="contenedor">
        <h1 className="logo">
          <br />
          <span className="nombre-empresa">Datos</span> Propuesta Económica
        </h1>
        <div className="wrapper animated bounceInLeft">
          <div className="info-empresa">
            <h3>
              <img className="logoPropuesta" src={logo}></img>
            </h3>
