        ...
        <Tbody>
          {Object.keys(props.dcats).map((key) => (
            <Tr key={key}>
              ...
              <Td>{props.dcats[key].cd_no_parte}</Td>
              <Td>{props.dcats[key].cd_descripcion}</Td>
              <Td>{props.dcats[key].cd_meses}</Td>
              <Td>{props.dcats[key].cd_semanas}</Td>
              <Td>{props.dcats[key].cd_comentarios}</Td>
