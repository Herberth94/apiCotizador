        ...
        <Tbody>
          {Object.keys(props.precios).map((key) => (
            <Tr key={key}>
              ...
              <Td>{props.precios[key].precio_lista}</Td>
              <Td>{props.precios[key].precio_unitario}</Td>
              <Td>{props.precios[key].precio_descuento}</Td>
              <Td>{props.precios[key].precio_total}</Td>
              <Td>
                <select
