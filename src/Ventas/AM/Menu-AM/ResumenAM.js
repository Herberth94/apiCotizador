      ...
      {show1 ? (
        ...
        <div className="animacion-table">
          ...
          <div className="">
            ...
            <div>
              {" "}
              <Animaciones mytext="Costos Indirectos " />{" "}
            </div>
            ...
            <div>
              ...
              <div>
                {" "}
                <Animaciones mytext="Costos Totales Finales " />{" "}
              </div>
                ...
                <Tbody>
                  ...
                  <Tr>
                    <Td className="amarillo">
                      {" "}
                      {"$ "}
                      {precioFinalVenta} {stringDolar}
                    </Td>
                    <Td className="azul">
                      {"$ "} {costoSinIndirectos} {stringDolar}
                    </Td>
                    <Td className="verde">
                      {"$ "} {costoFianalProyecto}{" "}
                    </Td>
